    ...
    return (
        <footer>
            ...
            <section className='px-5 py-5 text-center text-white bg-black text-sm'>
                <p>&copy; {currentYear} All right reserved. Developed by <a href="https://www.developersajeeb.com" target="_blank"><span className='text-color font-semibold'>DeveloperSajeeb</span></a></p>
            </section>
        </footer>
    );
};
