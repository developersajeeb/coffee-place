...
const Services = () => {
    return (
        <section className='grid md:grid-cols-3 gap-6 mt-28'>
            <div className='bg-cover bg-center h-80' style={{ backgroundImage: `url(${'/others/service1.jpg'})` }}>
            ...
            <div className='bg-cover bg-center h-80' style={{ backgroundImage: `url(${'/others/service2.jpg'})` }}>
                <div className='m-12 border flex justify-center items-center border-[#B99272] text-center h-56'>
                    <div>
            ...
            <div className='bg-cover bg-center h-80' style={{ backgroundImage: `url(${'/others/service3.jpg'})` }}>
                <div className='m-12 border flex justify-center items-center border-[#B99272] text-center h-56'>
                    <div>
