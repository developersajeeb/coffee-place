    ...
    return (
        <nav className='bg-[#0E1317]'>
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3 md:px-16 lg:px-0">
                <Link href='/'>
                    <Image src='/logo.png' alt='Coffee Place' width={70} height={70} />
                </Link>
                ...
                <ul className={`text-white p-10 pt-3 grid gap-5 w-full text-center bg-[#0E1317] md:hidden absolute duration-500 z-10 ${isOpen ? 'right-0 top-20' : 'right-0 -top-96'}`}>
