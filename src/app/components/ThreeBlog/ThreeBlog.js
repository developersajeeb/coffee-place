    ...
    return (
        <>
            ...
            <div className='grid md:grid-cols-3 gap-8 mt-16'>
                <div style={{ backgroundImage: 'url(https://kaffen-reactjs.netlify.app/images/latest_blog1.jpg)' }} className='bg-cover bg-center bg-no-repeat text-white h-96 relative'>
                ...
                <div style={{ backgroundImage: 'url(https://kaffen-reactjs.netlify.app/images/latest_blog2.jpg)' }} className='bg-cover bg-center bg-no-repeat text-white h-96 relative'>
                    <div className='absolute bottom-0 bg-gradient-to-t from-gray-900 px-6 pb-6 pt-36'>
                ...
                <div style={{ backgroundImage: 'url(https://kaffen-reactjs.netlify.app/images/latest_blog3.jpg)' }} className='bg-cover bg-center bg-no-repeat text-white h-96 relative'>
                    <div className='absolute bottom-0 bg-gradient-to-t from-gray-900 px-6 pb-6 pt-36'>
                        <h3 className='text-xl'>SWR React Hooks With Next Increm Ental Static Regeneration</h3>
                        <ul className='flex items-center gap-4 mt-3'>
                            <li className='flex items-center gap-1 text-gray-300'><FaRegCalendarAlt /> <span>3 July 2023</span></li>
